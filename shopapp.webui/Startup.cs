...
namespace shopapp.webui
{
    public class Startup
    {
        ...
        {
            // MigrationsAssembly("shopapp.data") ekleyerek migrationlarýn data katmanýnda oluþmasýný saðlýyoruz.
            services.AddDbContext<ApplicationContext>(options =>
                options.UseSqlServer(_configuration.GetConnectionString("MsSqlConnection"),
                builder => builder.MigrationsAssembly("shopapp.webui")));

            services.AddDbContext<ShopContext>(options =>
                options.UseSqlServer(_configuration.GetConnectionString("MsSqlConnection"),
                builder => builder.MigrationsAssembly("shopapp.data")));
